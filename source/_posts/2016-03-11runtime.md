...
---
title: 揭开runtime运行时的神秘面纱
date: 2016-03-11 17:18:24
categories: iOS
tags: [iOS]
comments: false
---
...
- 对于OC的函数，属于**动态调用**过程，在编译的时候并不能决定真正调用哪个函数，只有在真正运行的时候才会根据函数的名称找到对应的函数来调用。
- 事实证明：
...
- 使用**消息机制前提**，必须导入`#import <objc/message.h>`
